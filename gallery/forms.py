...
class SearchForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Alapértelmezésként kiválasztjuk a "Város" és "Természet" címkéket, ha rendelkezésre állnak
        default_tags = Tag.objects.filter(name__in=["Város", "Természet"])
        self.fields['tags'].initial = default_tags
